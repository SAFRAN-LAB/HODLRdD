...
\hypertarget{list_8hpp_source}{}\label{list_8hpp_source}\index{lib/cereal/types/list.hpp@{lib/cereal/types/list.hpp}}
...
\DoxyCodeLine{00030\ \textcolor{preprocessor}{\#ifndef\ CEREAL\_TYPES\_LIST\_HPP\_}}
\DoxyCodeLine{00031\ \textcolor{preprocessor}{\#define\ CEREAL\_TYPES\_LIST\_HPP\_}}
\DoxyCodeLine{00032\ }
...
\DoxyCodeLine{00040\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{macros_8hpp_a85b7884671ac5a804b66ec7c34d0ca71}{CEREAL\_SAVE\_FUNCTION\_NAME}}(\ Archive\ \&\ ar,\ std::list<T,\ A>\ \textcolor{keyword}{const}\ \&\ list\ )}
\DoxyCodeLine{00041\ \ \ \{}
\DoxyCodeLine{00042\ \ \ \ \ ar(\ \mbox{\hyperlink{classcereal_1_1_size_tag_a4d4b256b14671c8270d06f40e4c4a077}{make\_size\_tag}}(\ \textcolor{keyword}{static\_cast<}\mbox{\hyperlink{namespacecereal_a0e01d80aaafe0efb12b75abdee310ae4}{size\_type}}\textcolor{keyword}{>}(list.size())\ )\ );}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \ \ \ \ \textcolor{keywordflow}{for}(\ \textcolor{keyword}{auto}\ \textcolor{keyword}{const}\ \&\ i\ :\ list\ )}
...
\DoxyCodeLine{00050\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{macros_8hpp_a854de4fbe2b80753b27264b7dda740e8}{CEREAL\_LOAD\_FUNCTION\_NAME}}(\ Archive\ \&\ ar,\ std::list<T,\ A>\ \&\ list\ )}
\DoxyCodeLine{00051\ \ \ \{}
...
\DoxyCodeLine{00054\ }
\DoxyCodeLine{00055\ \ \ \ \ list.resize(\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{size\_t}\textcolor{keyword}{>}(\ size\ )\ );}
\DoxyCodeLine{00056\ }
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keywordflow}{for}(\ \textcolor{keyword}{auto}\ \&\ i\ :\ list\ )}
\DoxyCodeLine{00058\ \ \ \ \ \ \ ar(\ i\ );}
\DoxyCodeLine{00059\ \ \ \}}
\DoxyCodeLine{00060\ \}\ \textcolor{comment}{//\ namespace\ cereal}}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ \textcolor{preprocessor}{\#endif\ }\textcolor{comment}{//\ CEREAL\_TYPES\_LIST\_HPP\_}}
